...
function normalizeApiVideo(raw) {
  return {
    ...
    thumbnailUrl: raw.posterUrl || FALLBACK_POSTER,
    heroImageUrl: raw.posterUrl || FALLBACK_POSTER,
    rating: typeof raw.rating === 'number' ? raw.rating : 7.5,
    ratingCount: raw.ratingCount || 0,
    year: raw.year || new Date().getFullYear(),
    duration: raw.runtime ? Math.round(raw.runtime) : 0,
    contentType: 'MOVIE',
    genres: (raw.genre || raw.subgenre) ? [raw.genre || raw.subgenre] : ['General'],
    ageRating: 'PG-13',
    muxPlaybackId: raw.videoUrl,
    views: raw.views || 0,
  };
}
